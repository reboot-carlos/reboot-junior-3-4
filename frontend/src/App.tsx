  ...
  return (
    <div className="h-screen bg-gradient-to-br from-white via-gray-50 to-gray-100 text-gray-900 flex flex-col overflow-hidden">
      ...
      <div className="flex flex-1 gap-4 p-4 bg-gradient-to-br from-purple-950 to-slate-950 overflow-hidden">
        {/* Sidebar - Navigation */}
        {selectedTheme && (
        <div className="w-72 bg-gradient-to-b from-blue-900 via-purple-900 to-slate-900 text-white rounded-xl p-6 flex-shrink-0 sidebar-enter shadow-lg overflow-y-auto" style={{height: "calc(100vh - 160px)"}}>
